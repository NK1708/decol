...
class WPPP_Admin_Settings {
	...
	public function add_settings( $settings ) {
		...
		$new_settings = array(
			...
			array(
				'title'	   => __( 'Drop-down location', 'patron' ),
				'desc'		  => __( '', 'patron' ),
				...
				'options'  => array(
					'top' 		=> __( 'Top', 'patron' ),
					'bottom' 	=> __( 'Bottom', 'patron' ),
					'topbottom' => __( 'Top/Bottom', 'patron' ),
					'none' 		=> __( 'None', 'patron' ),
				),
				'desc_tip' =>  true,
			),
			...
			array(
				'title'			=> __( 'List of dropdown options', 'patron' ),
				'desc'			=> __( 'Seperated by spaces <em>(-1 for all products)</em>', 'patron' ),
			...
			array(
				'title'			=> __( 'Default products per page', 'patron' ),
				'desc'			=> __( '-1 for all products', 'patron' ),
				'id'			=> 'wppp_default_ppp',
			...
			array(
				'title'			=> __( 'First category page', 'patron' ),
				'desc'			=> __( 'When checked and a new number of PPP is selected, the visitor will be send to the first page of the product category', 'patron' ),
			...
			array(
				'title'		=> __( 'HTTP method', 'patron' ),
				'desc'		=> __( 'GET sends the products per page via the url, POST does this on the background', 'patron' ),
				'id'		=> 'wppp_method',
				'class'		=> 'wc-enhanced-select',
				'default'	=> 'post',
				'type'		=> 'select',
